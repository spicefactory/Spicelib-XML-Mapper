...
[Metadata(name="Attribute", types="property")]
/**
 * Represents a Metadata tag that can be used on properties that should map to XML attributes.
 *
 * @author Jens Halm
 */
public class AttributeDecorator implements MetadataMapperDecorator {
	...
	public function decorate (builder:MetadataMapperBuilder) : void {
		...
		builder.mapToAttribute(property, new QName(uri, name));
	}
